...
import { validateModule } from './ums-module-loader.js';
...
describe('UMS Module Loader', () => {
  describe('validateModule', () => {
    ...
    it('should reject module with undeclared directive in body', () => {
      ...
      expect(result.errors[0].message).toContain('is not declared');
    });
    ...
    it('should reject module with missing required directive', () => {
      ...
      expect(result.errors[0].message).toContain('Required directive');
    });
